...
<body>
    ...
    if (isset($_GET['txtGarage']) && !empty($_GET['txtGarage'])) {
        ...
        $sql = "SELECT idUtilisateur,description, image, dateDebut, dateFin, adresse, ville, province FROM garage
        WHERE province LIKE  '%$getText%' ORDER BY province";
            ...
            ?>
                <div class="card" style="width: 30rem;">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-2 text-muted"><?php echo'<img style="width:250px;height:250px;border-raduis;:500px" src = "'. $row['image'].'"/>' ?></h6>
                        ...
                        <h6 class="card-subtitle mb-2 text-muted">Ville : <?php echo $row['province']; ?></h6>
                    </div>
                </div>    
                <br />
